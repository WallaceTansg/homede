...
table(test_relevance)

test_relevance <- ifelse(test_relevance>2.5,3,test_relevance)
test_relevance <- ifelse(test_relevance<=1.81,1,test_relevance)
test_relevance <- ifelse(test_relevance>1.81 & test_relevance<2.49,2,test_relevance)
