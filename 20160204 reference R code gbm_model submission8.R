...
, data=train, kmax =5,distance=0.01,  kernel ="optimal")
#
#all optimal
...
write_csv(submission ,"DepotMatchScore_submission14.csv")
...
#################################################
??gbm.fit
gbm_model <- gbm.fit(train[,8:10],train$relevance,distribution ="gaussian",interaction.depth =10,shrinkage=0.3,bag.fraction = 0.3,n.trees=1000)
...
write_csv(submission ,"DepotMatchScore_submission13.csv")
print(Sys.time()-t)