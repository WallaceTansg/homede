...
lines(lowess(train$mscore_termdesc,train$relevance),col=2)
points(train$mscore_termdesc,train$relevance, pch=".",col= 2)

plot(train$mscore_titeldesc,train$relevance, ylab="Weight (g)",xlab="Time (Month)", pch=".")
lines(lowess(train$mscore_titeldesc,train$relevance),col=2)
points(train$mscore_titeldesc,train$relevance, pch=".",col= 2)
